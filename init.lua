...
local mirrors = {
    e_counter = make_mirror({
        src = { x = 1, y = 37, w = 73.5, h = 9 },
        dst = { x = cfg.e_count.x, y = cfg.e_count.y, w = 73.5 * cfg.e_count.size, h = 9 * cfg.e_count.size },
